...
# -*- coding: utf-8 -*-
"""
Created on Sun Jan  5 15:39:01 2025
...
approximate mu that doesnt change for each potential in loss function
'''
...
for epoch in range(n_iters):
    ...
    for inputs, target, v0s, sigs, x0s, pots in train_loader:
        ...
        if (((epoch+1)%10==0) and (i==0)):
            ...
            # plt.plot(x_plot,torch.zeros_like(x_plot))
        ...
        loss =  MSE + theta_scalar*torch.sum(theta)/len(theta) #+ torch.sum(mu_dep_loss**2)/5000000
...
# plt.tight_layout()
# plt.savefig('scatter_in_9_6_pt4.pdf')
# plt.show()
# =============================================================================
...
# ax3.set_zticklabels([])
plt.tight_layout()
plt.savefig('surface_in_9_6_pt4.pdf')
plt.show()
...
ax6.grid()
plt.tight_layout()
plt.savefig('swarm_in_18_6_pt4.pdf')
plt.show()
...
# ax7.grid()
# plt.tight_layout()
# plt.savefig('line_in_18_6_pt4.pdf')
# plt.show()
# =============================================================================
...
ax8.grid()
plt.tight_layout()
plt.savefig('spreadoutx_in_18_6_pt4.pdf')
plt.show()
...
ax9.grid()
plt.tight_layout()
plt.savefig('avgtrainv_in_9_6_pt4.pdf')
plt.show()
...
ax10.legend()
plt.tight_layout()
plt.savefig('train_test_curve1_in_9_6_pt4.pdf')
plt.show()
...
plt.tight_layout()
plt.savefig('parity_plot_in_9_6_pt4.pdf')
plt.show()
...
plt.tight_layout()
plt.savefig('mosaic_in_9_6_pt4.pdf')
plt.show()
...
# ax13.legend()
plt.tight_layout()
plt.savefig('theta_vs_epochs_in_9_6_pt4.pdf')
plt.show()
...
# ax3.set_zticklabels([])
plt.tight_layout()
plt.savefig('theta_surface_in_9_6_pt4.pdf')
plt.show()
