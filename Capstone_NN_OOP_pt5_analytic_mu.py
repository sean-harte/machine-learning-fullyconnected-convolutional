...
# -*- coding: utf-8 -*-
"""
Created on Sat Jan 11 16:02:18 2025
...
class NeuralNet(nn.Module):
    ...
    # def forward(self, x):
    #     x = self.fc1(x) #  self.relu(
    #     x = self.fc2(x) #  self.relu(
    #     x = self.fc3(x) #  self.relu(
    #     x = self.fc4(x) #  self.relu(
    #     x = self.fc5(x) #  self.relu(
    #     x = self.fc6(x)
    #     return x
...
#             loss =  torch.sum(mu_dep_loss**2)
#         elif((epoch+1)%2==0 and epoch ==-1):
#             loss =  MSE #+ torch.sum(mu_dep_loss**2)/(5000000)
#         else:
#             loss =  MSE + torch.sum(mu_dep_loss**2)/(4000000)
# =============================================================================
    ...
    for inputs,target,v0s,sigs,x0s,pots in test_loader: # theta_scalar*(sum_theta)/len(theta) + 
        ...
        if(epoch == n_iters-1):
            ...
            for j in range(len(x0s)):
                ...
                axq.legend()
                plt.tight_layout()
                plt.savefig('ML_funcderiv_9_6_pt5.pdf')
                plt.show()
...
plt.tight_layout()
plt.savefig('scatter_in_9_6_pt5.pdf')
plt.show()
...
# ax3.set_zticklabels([])
plt.tight_layout()
plt.savefig('surface_in_9_6_pt5.pdf')
plt.show()
...
ax6.grid()
plt.tight_layout()
plt.savefig('swarm_in_18_6_pt5.pdf')
plt.show()
...
ax7.grid()
plt.tight_layout()
plt.savefig('line_in_18_6_pt5.pdf')
plt.show()
...
ax8.grid()
plt.tight_layout()
plt.savefig('spreadoutx_in_18_6_pt5.pdf')
plt.show()
...
ax9.grid()
plt.tight_layout()
plt.savefig('avgtrainv_in_9_6_pt5.pdf')
plt.show()
...
ax10.legend()
plt.tight_layout()
plt.savefig('train_test_curve1_in_9_6_pt5.pdf')
plt.show()
...
plt.tight_layout()
plt.savefig('parity_plot_in_9_6_pt5.pdf')
plt.show()
...
plt.tight_layout()
plt.savefig('mosaic_in_9_6_pt5.pdf')
plt.show()
...
# ax13.legend()
plt.tight_layout()
plt.savefig('theta_vs_epochs_in_9_6_pt5.pdf')
plt.show()
...
# ax3.set_zticklabels([])
plt.tight_layout()
plt.savefig('theta_surface_in_9_6_pt5.pdf')
plt.show()
